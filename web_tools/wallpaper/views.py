...
def visualize(request, id):
    ...
    if request.method == "GET":
        ...
        wall = Image.new('RGB', (wall_width * 10, wall_height * 10), (255, 255, 255))
        ...
        wall_blur_draw.rectangle((0, 0, 30, wall_blur.size[1]), (0, 0, 0, 64))
        wall_blur_draw.rectangle((0, 0, wall_blur.size[0], 30), (0, 0, 0, 64))
        wall_blur_draw.rectangle((0, wall_blur.size[1] - 30, wall_blur.size[1], wall_blur.size[0]), (0, 0, 0, 64))
        wall_blur_draw.rectangle((wall_blur.size[0] - 30, 0, wall_blur.size[0], wall_blur.size[1]), (0, 0, 0, 64))
